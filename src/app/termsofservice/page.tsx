    ...
    <div className="flex min-h-screen flex-col bg-imprint-bg">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12 sm:py-16">
        ...
        <p className="text-base leading-relaxed text-imprint-muted">
          The full terms of use for Imprint would appear here. You can view the
          complete terms on the official Imprint website at{" "}
          <a
            href="https://imprintapp.com/termsofservice"
            target="_blank"
            rel="noopener noreferrer"
            className="text-imprint underline hover:text-imprint-hover"
          >
            imprintapp.com/termsofservice
          </a>
          .
        </p>
      </main>
